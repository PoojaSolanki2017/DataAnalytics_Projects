...
Measured the effectiveness of SMS reminders in reducing appointment cancellations.

Lead Time Analysis

Determined whether longer waiting periods increased cancellation probability.
...
Instead of processing data on a single machine, this project utilized Spark's distributed computing framework.
...
Transformations
Analytics
Customer/Patient churn-style analysis
